...
function updateTimeFrame(){
	...
	if (h >= 6 && h < 8){ //Sunrise
        ...
        document.getElementById ('body').style.backgroundImage = "url('sunset.png')"; //sunrise
        ...
        document.getElementById ('body').style.backgroundImage = "url('Day.png')"; //day
        document.body.style.backgroundRepeat = "no-repeat";
        document.body.style.backgroundSize = "cover";
    ...
    } else if (h >= 17 && h <18) { //sundown
        document.getElementById('body').style.backgroundColor = ('#e76243') //sundown
        document.getElementById ('body').style.backgroundImage = "url('sunset.png')"; //sundown
        document.body.style.backgroundRepeat = "no-repeat";
        document.body.style.backgroundSize = "cover";
        ...
        document.getElementById ('body').style.backgroundImage = "url('Evening.png')"; //Night
        document.body.style.backgroundRepeat = "no-repeat";
        document.body.style.backgroundSize = "cover";
